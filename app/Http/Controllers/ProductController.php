...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('products.index')->with('success', 'Product created successfully.')->with('success', 'Create product successfully.');
    ...
    {
        //
        $productdelete = $this->productService->destroy($productId);
